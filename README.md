...
OpportunityRadar 不只服务学生，也服务**正在寻找下一步的人**：
高中生、大学生、研究生、应届生、职场新人、资深 IC、管理者、研究者、自由职业者、创始人、
转行者、职业空窗期、准备重新读书的人、准备跨国发展的人。

OpportunityRadar 让 Agent 不再只搜你给出的几个关键词。它会根据你的背景和目标继续找相关方向，回到官方页面核实报名时间和申请要求，最后挑出真正值得你花时间看的机会。**你问的是“我能做什么”，得到的不该只是一页链接。**

## 它帮你回答三个问题

| 问题 | OpportunityRadar 的做法 |
|---|---|
| **Discover** 我不知道还有什么机会 | 跨 13 类机会、多地区多语言搜索，回到官方来源核实 |
| **Decide** 这些里什么最值得现在投入 | 资格 + 准备度 + 投入产出 + 未来通道 → 给出 High / Medium / Low 与理由 |
| **Develop** 我现在做什么能打开更多机会 | 缺口 → 真实学习型机会（桥接）→ 可展示成果 → 更高层级机会 |

> 定位：**Personal Opportunity Intelligence**。\
> 它不是搜索引擎、不是招聘板、不是课程推荐、不是职业性格测试。\
> 它不会输出"录取率 72%"，也不会预测你未来能涨薪多少。
